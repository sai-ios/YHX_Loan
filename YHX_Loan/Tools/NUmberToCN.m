...
@implementation NUmberToCN

+(NSString*)numberToCN:(NSString*)number{
    
    //首先转化成标准格式        “200.23”
    NSMutableString *tempStr=[[NSMutableString alloc] initWithString:[NSString stringWithFormat:@"%.2f",[number doubleValue]]];
    //位
